...
public class Blackjack
{
    ...
    //this method Lets the user play one game of Blackjack.
    ...
    static boolean playBlackjack()
    {
       ...
       {   
    	   ...
    	   System.out.println("Your cards are:");
            ...
            do {
               userAction = (char) Character.toUpperCase( input.nextInt() );
            ...
            //(and it's the dealer's turn to draw cards).
            if ( userAction == 'S' )
              {
       ...
       // If we get to this point, the user has Stood with 21 or less. 
       //Now, it's the dealer's chance to draw.  Dealer draws cards until the dealer's total is > 16.
       ...
       //If we get to this point, both players have 21 or less.  
       //We can determine the winner by comparing the values of their hands.
       System.out.println();
